...
function recebeObj(livro) {
  return "O livro ".concat(livro.titulo).concat(" foi escrito por ").concat(livro.autoria).concat(" e tem ").concat(livro.paginas).concat(" páginas");
}
console.log(recebeObj(objLivro('Antes do Baile Verde', 234, 'Lygia Fagundes Telles')));
...
console.log(dadosPessoa('Monique', 'Dália'))
