...
function retorneMaiorNumero(numerosInteiros) {
  let maiorNumero = 0;
  for (let a = 0; a < numerosInteiros.length; a++) {
    if (maiorNumero < numerosInteiros[a]) {
      maiorNumero = numerosInteiros[a];
    }
  }
  return maiorNumero;
}
console.log(retorneMaiorNumero([56, 12, 168, 66]))
...
function retorneMenorEMaiorNumero(numerosInteiros) {
  let menorNumero = 0;
  let maiorNumero = 0;
  for (let a = 0; a < numerosInteiros.length; a++) {
    if (maiorNumero < numerosInteiros[a]) {
    ...
    if (menorNumero > numerosInteiros[a]) {
      menorNumero = numerosInteiros[a];
    }
  }
  return "o maior número é 59 e o menor número é -5";
}
console.log(retorneMenorEMaiorNumero([5, 37, 18, 59, 12, -5]))